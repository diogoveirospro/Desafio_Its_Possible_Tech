...
import { MockJobCreatedEvent } from './mocks/events/mockJobCreatedEvent.js'
import { MockJobDeletedEvent } from './mocks/events/mockJobDeletedEvent.js'
import { MockJobAggregateRoot } from './mocks/domain/mockJobAggregateRoot.js'
import { MockPostToSocial } from './mocks/services/mockPostToSocial.js'
import { MockJobAggregateRootId } from './mocks/domain/mockJobAggregateRootId.js';
...
describe('Domain Events', () => {
  ...
  describe('Given a JobCreatedEvent, JobDeletedEvent and a PostToSocial handler class', () => {
    ...
    it('Should add the event to the DomainEvents list when the event is created', () => {
      ...
      const _domainEventsAggregateSpy = sinon.spy(DomainEvents, "markAggregateForDispatch");
    ...
    it('Should call the handlers when the event is dispatched after marking the aggregate root', () => {
      ...
      // eslint-disable-next-line @typescript-eslint/no-unused-vars
      const _jobCreatedEventSpy = sinon.spy(social, "handleJobCreatedEvent");
      // eslint-disable-next-line @typescript-eslint/no-unused-vars
      const _jobDeletedEventSpy = sinon.spy(social, "handleDeletedEvent");
